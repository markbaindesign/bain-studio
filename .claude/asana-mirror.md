...
| ID | Task | Status |
|----|------|--------|
| BSTD-022 | Conduct a security audit on the studio project | 2026-06-04 OVERDUE |
| BSTD-005 | Replace ASANA_PAT with bainbot account token | no due date |
| BSTD-009 | Automate case study → website delivery pipeline | no due date |
